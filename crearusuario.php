            ...
            <form method="POST" action="">
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nombre" class="form-control" required value="<?php echo isset($_POST['nombre']) ? $_POST['nombre'] : ''; ?>">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Apellido</label>
                        <input type="text" name="apellido" class="form-control" required value="<?php echo isset($_POST['apellido']) ? $_POST['apellido'] : ''; ?>">
                    </div>
                    <div class="col-12">
